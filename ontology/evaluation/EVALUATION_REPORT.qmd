...
**Materialization Time:** 1,056ms (1,642 triples)
**Cold Start:** 357ms (first query)
**Peak Memory:** 47.4 MB
...
Additionally, even if safety rules could be expressed:
- Safety query p95 of 14.6ms **fails the <10ms requirement** by 1.46x
- Performance is ~3x faster than Vampire but ~1,460x slower than Prolog
...
## Selected Architecture: Single-Reasoner (Vampire Only)
