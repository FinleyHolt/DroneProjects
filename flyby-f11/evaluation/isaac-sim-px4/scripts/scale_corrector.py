...
Copied from flyby-f11/ros2_ws/src/flyby_depth/flyby_depth/scale_corrector.py
for use in Isaac Sim depth avoidance testing.
"""
...
class ScaleCorrector:
    ...
    def apply_scale(
        ...
        # Only apply min clamp, no max clamp unless specified
